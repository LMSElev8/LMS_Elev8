...
namespace LMS_Project.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UniqueId,UserId,CourseId,EnrollmentDate")] Enrollment enrollment)
        {
            if (id != enrollment.UniqueId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!EnrollmentExists(enrollment.UniqueId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Enrollments?.Any(e => e.UniqueId == id)).GetValueOrDefault();
        }
    }
}
